...
<h1>Page Heroes</h1>
<p class="admin-page-intro">The banner shown at the top of every inner page (About, Courses, Testimonials, Alumni, Blog, Notes, Contact), rendered by one shared component so they all look the same. The Home page's own hero is managed separately under Homepage Content and is not affected here.</p>
