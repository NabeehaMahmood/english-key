/* ============ EnglishKeys Academy — FAQ Assistant ============
   ...
   a handful of generic answers (fee, timing, enrolment, payment, contact)
...
(function () {
  ...
  var TOPICS = 'fees, timings, enrolment, payment and contact';
  ...
  var KB = [
    ...
    { keys: ['enrol','enroll','admission','register','join','sign up','how to start'],
      q: 'How do I enrol?',
      a: 'Two easy ways: fill the <a href="/enroll">enrolment form</a> (takes 2 minutes) or message us directly on <a href="{{waLink}}" target="_blank" rel="noopener">WhatsApp ({{whatsapp}})</a>. We reply within 3 hours.' },
  ...
  function open(){
    ...
    if (!greeted) {
      ...
      setTimeout(function(){
        t.remove();
        addMsg('Assalam-o-alaikum! 👋 I’m the EKA AI Assistant. Ask me anything about EnglishKeys Academy — courses, fees, timings, results, notes, enrolment — or tap a question:', 'bot');
        addChips();
      }, 550);
    }
  }
